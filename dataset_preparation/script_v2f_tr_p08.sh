...
# ----------------------------------------------------------------------------------
# variable
data_path=/home/czh/lxy/data/EgoAction/EPIC/EPIC_KITCHENS_2018/frames_rgb_flow/rgb/train/  # /dataset/hmdb51/ # depend on users
video_in='P08'
...
class_file=class_list_tr_p08.txt # ../data/hmdb51_splits/class_list_hmdb_ucf_small.txt # none | XXX/class_list_DA.txt (depend on users)
