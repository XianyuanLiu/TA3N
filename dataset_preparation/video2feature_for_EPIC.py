...
parser.add_argument('--input_type', type=str, required=False, default='frames', choices=['video', 'frames'],
                    help='input types for videos')
parser.add_argument('--structure', type=str, required=False, default='tsn', choices=['tsn', 'imagenet'],
...
parser.add_argument('--class_file', type=str, required=False, default='class_list.txt',
...
def extract_features(video_file):
    ...
    if args.input_type == 'video':
        ...
        list_frames = os.listdir(path_input + class_name + '/')
        list_frames.sort()
...
def extract_features_epic(frame_file):
    ...
    id_frame_name = str(frame_file[-11:-4]).zfill(7)
    if args.structure == 'tsn':
        filename = path_output + class_name + '/' + 'img_' + id_frame_name + feature_in_type
